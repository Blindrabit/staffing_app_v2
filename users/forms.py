...
class MyCustomSignupForm(SignupForm):
    ...
    def save(self, request):
        ...
        cleaned_hos_data = self.cleaned_data['hospitals'].values_list(
            'pk', flat=True)
        cleaned_area_data = self.cleaned_data['area_to_work'].values_list(
            'pk', flat=True)
        user.save()
